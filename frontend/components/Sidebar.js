...
const Sidebar = () => {
  ...
  const drawer = (
    <>
      ...
      <div
        className={`${
          router.pathname.startsWith('/app/dashboard')
            ? 'isActive'
            : 'sidebar-svg'
      ...
      <div className="treatmentGrp">
        ...
        <div
          className={`${
            router.pathname.startsWith('/app/klientinnen')
              ? 'isActive'
              : 'sidebar-svg'
        ...
        <div
          className={`${
            router.pathname.startsWith('/app/dokumentenvorlage')
              ? 'isActive'
              : 'sidebar-svg'
          } sidebar-svg flex items-center pt-2.5 pb-2.5  pl-6 cursor-pointer bg-[#fff] hover:bg-[#2b86fc1a]`}
      ...
      <div className="treatmentGrp">
        ...
        <div
          className={`${
            router.pathname.startsWith('/app/begruendungstexte')
              ? 'isActive'
              : 'sidebar-svg'
          } sidebar-svg flex items-center pt-2.5 pb-2.5  pl-6 cursor-pointer bg-[#fff] hover:bg-[#2b86fc1a]`}
        ...
        <div
          className={`${
            router.pathname.startsWith('/app/leistungen')
              ? 'isActive'
              : 'sidebar-svg'
          } sidebar-svg flex items-center pt-2.5 pb-2.5  pl-6 cursor-pointer bg-[#fff] hover:bg-[#2b86fc1a]`}
      ...
      <div className="treatmentGrp">
        ...
        <div
          className={`${
            router.pathname.startsWith('/app/kontoeinstellungen')
              ? 'isActive'
              : 'sidebar-svg'
          } sidebar-svg flex items-center pt-2.5 pb-2.5  pl-6 cursor-pointer bg-[#fff] hover:bg-[#2b86fc1a]`}
